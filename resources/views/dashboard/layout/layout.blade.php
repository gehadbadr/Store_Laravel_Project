...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard') }}/assets/css/style2.css">
    <livewire:styles />
                        ...
                        <li class="onhover-dropdown">
                            <div class="media align-items-center">
                                <img class="align-self-center pull-right img-50 blur-up lazyloaded"
                                    src="assets/images/dashboard/user.jpg" alt="header-user">
                            ...
                            <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                        <i data-feather="log-out"></i><a href="javascript:void" onclick="$('#logout-form').submit();">Logout</a>
